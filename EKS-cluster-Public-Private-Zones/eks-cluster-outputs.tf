...
output "eks_private_node_group_id" {
  value = aws_eks_node_group.eks_cluster_node_group_private.id
}

output "eks_private_node_group_arn" {
  value = aws_eks_node_group.eks_cluster_node_group_private.arn
}

output "eks_private_node_group_status" {
  value = aws_eks_node_group.eks_cluster_node_group_private.status
}

output "eks_private_node_group_version" {
  value = aws_eks_node_group.eks_cluster_node_group_private.version
}